 ...
 *6)emptycol         */
static const char *colors[] =	 {"#35586c",	//focus
				"#333333",	//unfocus
				"#7a8c5c",	//fixed
				"#ff6666",	//unkill
				"#cc9933",	//fixunkill
...
static const uint8_t borders[] = 	{5,	//outer border size
					15,	//full border width
...
static const char *terminal[]  = { "urxvt" , "-e" , "mksh" , NULL };
static const char *mpdmenu[]   = { "mpdmenu.sh" , NULL };
static const char *lock[]      = { "manablockscreen" };
static const char *pausecmd[]  = { "ncmcpcpp" , "toggle" , NULL };
static const char *prevcmd[]   = { "ncmcpcpp" , "prev" , NULL };
static const char *nextcmd[]   = { "ncmcpcpp" , "next" , NULL };
///--Custom foo---///
...
static key keys[] = {
    ...
    {  MOD ,              XK_F5,         start,             {.com = pausecmd}}, 
    {  MOD ,              XK_F4,         start,             {.com = prevcmd}}, 
    {  MOD ,              XK_F6,         start,             {.com = nextcmd}}, 
    {  MOD , 		  XK_Escape,	 start,		    {.com = lock}},
    {  MOD ,		  XK_e,	         start,		    {.com = mpdmenu}},
